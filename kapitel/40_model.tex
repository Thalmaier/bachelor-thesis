...
\domainModell{Basket-Klasse}{
	...
	\item \textbf{BasketStatus: } {Repräsentiert den aktuellen Zustand des Baskets. Mögliche Werte sind analog zur Ubiquitous Language 'OPEN', 'FROZEN', 'FINALIZED' und 'CANCELED'.} 
	...
	\item \textbf{Order: } {Speichert eine Referenz auf den Bestellvorgang eines Baskets, welche erst nach Zahlungsabschluss befüllt wird.}  
}
