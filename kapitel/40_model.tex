...
\begin{table}[h!]
	\centering
	\begin{tabular}{ | >{\centering\arraybackslash}m{0.16\textwidth} | m{0.28\textwidth} | m{0.46\textwidth} | } 
		\hline
