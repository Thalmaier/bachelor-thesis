...
Die Binärdateien des Projekts wurden zur Versionierung in ein Git-Repository hinterlegt. Diese umfassen die Definition der Lasttests, API-Beschreibung, und den Quelltext, inklusive der analysierten Aggregationsschnitte. Das Repository kann unter dem Link '\url{https://github.com/Thalmaier/bachelor-thesis-checkout-poc}' aufgerufen werden. Alternativ ist in Anhang \ref{fig:Github} ein QR-Code zum Scannen mit einer Kamera abgebildet.
