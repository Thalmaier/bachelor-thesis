...
\note{TODO der Verlinkung auf das Repository}
...
\begin{figure}[h!]
	\centering
	\includesvg[inkscapelatex=false, width=\textwidth, height=0.9\textheight]{svg/REST API.svg}
	\caption{REST-API der Checkout-Software für diesen Proof-of-Concept}
	\label{fig:REST-API}
\end{figure}

\section{Komplettes Datenmodell des Proof-of-Concepts} \label{label:Daten-Modell}
