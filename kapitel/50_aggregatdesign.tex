...
Zur Durchführung der Applikationslogik werden Services und Repositories benötigt. Der Proof-of-Concept verwendet für die Erstellung dieser Objekten das Prinzip der Dependency Injection. Ein Framework initialisiert hierbei erforderlichen Objekte durch ihren Konstruktor, indem die notwendigen Parameter ebenfalls injiziert werden. Dadurch entsteht ein rekursives Muster bis schließlich alle Objekte erzeugt worden sind.
