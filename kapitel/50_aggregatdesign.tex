...
\begin{figure}[H]
	\centering
	\includesvg[inkscapelatex=false, width=0.70\textwidth]{svg/VarB.svg}
...
\subsection{Parallele Bearbeitbarkeit von Aggregates}
...
\subsubsection{Wann muss sowohl der Basket als auch das Calculation-Result bearbeitet werden?}
...
\begin{figure}[htpb]
	\centering
	\footnotesize
	\includesvg[height=175pt]{svg/Performance Database.svg}
...
Zusammenfassend existiert nur sehr beschränkt eine Grundlage für die Anwendung von \text{Variante D} oder ähnlichen Aggregationsschnitten.