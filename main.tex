...
\usepackage[footskip=50pt, textheight=700pt]{geometry}
...
\subtitle{ \vspace{2ex} \LARGE Bachelorarbeit}

\author{Simon Thalmaier \\ 00108692}
...
\publishers{
  \begin{tabular}{rl}
   ...
   \textbf{Ausgabedatum} 	& 15.03.2022		\\
   \textbf{Abgabedatum} 	& 09.06.2022		\\
  \end{tabular}
  }
...
\newcommand{\groupedDomainModell}[2]{
	\begin{minipage}{\linewidth}\domainModell{#1}{#2}\end{minipage}
}
...
\newcommand{\domainItem}[2][]{
	\begin{minipage}{\linewidth}
		\ifthenelse { \equal {#1} {} }
			{ \item \textbf{#1: } {#2} }  % if #1 == blank
			{ \item #2 }
	\end{minipage}
}
...
\begin{document}
  ...
  \printglossary[type=main, nonumberlist, style=super]
